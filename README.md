...
| v3.0.0  | Basic UI editor (v2 interface) | Same expansion management system as v2             | Basic UI viewer (v2 interface)      | ✅ (Legacy)        | Not measured | Not measured | Not measured     | 🧱 Legacy         | Development cancelled after Beta Release 1   |
