...
| ------- | ------------------------------ | -------------------------------------------------- | ----------------------------------- | ----------------- | ------------ | ------------ | ---------------- | ----------------- | -------------------------------------------- |
| v4.0.0  | UI-based snippet editor        | Modular system for snippets, triggers, and hotkeys | Dedicated snippet manager interface | Not confirmed                 | Unknown      | ~90 MB      | ~11 MB          | 🚧 In Development | No production release available yet          |
